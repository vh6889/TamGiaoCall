...
// Lấy danh sách telesale cho modal
...
<div class="table-card">
                    ...
                    <tr id="order-row-<?php echo $order['id']; ?>">
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <?php if ($order['status'] === 'new' && !$order['assigned_to'] && !is_admin()): ?>
    ...
    <nav>
        <ul class="pagination justify-content-center">
            <?php if ($page > 1): ?>
            <li class="page-item">
                <a class="page-link" href="?page=<?php echo $page - 1; ?>&status=<?php echo $filter_status; ?>&search=<?php echo urlencode($filter_search); ?>&date_from=<?php echo $filter_date_from; ?>&date_to=<?php echo $filter_date_to; ?>">
            ...
            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                ...
                <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                    <a class="page-link" href="?page=<?php echo $i; ?>&status=<?php echo $filter_status; ?>&search=<?php echo urlencode($filter_search); ?>&date_from=<?php echo $filter_date_from; ?>&date_to=<?php echo $filter_date_to; ?>">
                        <?php echo $i; ?>
                    </a>
                </li>
...
$(document).ready(function() {
    ...
    $('#btnSaveAssignment').click(function() {
        ...
        $.ajax({
            ...
            complete: function() { 
                btn.prop('disabled', false).text('Lưu phân công'); 
            }
        });
    });
});
